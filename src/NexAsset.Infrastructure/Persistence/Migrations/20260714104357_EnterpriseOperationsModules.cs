...
{
    /// <inheritdoc />
    public partial class EnterpriseOperationsModules : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsumableCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consumables_InventoryItems_InventoryItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consumables_ConsumableCode",
                table: "Consumables",
                column: "ConsumableCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Consumables_InventoryItemId",
                table: "Consumables",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_OrganizationId_Code",
                table: "Customers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_OrganizationId_RequestNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTickets_OrganizationId_TicketNumber",
                table: "ServiceTickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemSettings_OrganizationId_Key",
                table: "SystemSettings",
                columns: new[] { "OrganizationId", "Key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Vendors_OrganizationId_Code",
                table: "Vendors",
                columns: new[] { "OrganizationId", "Code" },
                unique: true);
        }
